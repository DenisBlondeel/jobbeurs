...
public class GetCompaniesAlphabeticallyOnContactHandler extends RequestHandler {

	@Override
	public void handleRequest(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		List<User> companies = this.getService().getAllCompaniesAlphabeticallyOnContact();
